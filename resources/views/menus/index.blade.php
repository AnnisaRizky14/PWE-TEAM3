                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-8 p-5 my-auto align-center">
                            <h1 class="fw-bold" style="color:rgb(255, 255, 255); font-size: 3rem; letter-spacing: 2px; text-transform: uppercase;">Katalog Menu Makanan & Minuman Temu Rasa</h1>
                            <p class="col-md-10">
                            Bingung cari makan minum yang pas? Jangan khawatir! Semua menu andalan kita udah dikumpulin di bawah sini. Yuk, langsung aja di-scroll!
                            </p>
        ...
        <div class="container" style="margin-bottom: 100px">
            <div class="row g-3">
                <div class="col-md-4 mb-3 d-none d-md-block">
                    <div class="flex-shrink-0 p-3 rounded-3 sticky-top menu-filter" style="background-color: #0b5b45; border-color: #0b5b45;">
                        <a href="/"
                        ...
                        <ul class="list-unstyled ps-0">
                            <li class="mb-1">
                                <button
                                    class="btn btn-toggle align-items-center text-white rounded collapsed"
                ...
                <div class="col-md-8">
                    <div class="alert alert-success" style="color: #0b5b45;" role="alert">
