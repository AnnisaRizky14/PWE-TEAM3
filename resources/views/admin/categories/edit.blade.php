...
@section('title', 'Edit Kategori Baru — Temu Rasa')
@section('content')
        ...
        <div class="container-fluid">
            <div class="page-title">
                <div class="card card-absolute mt-5 mt-md-4">
                    ...
                    <div class="card-body">
                        <p>
                            Dibawah ini adalah halaman untuk edit data kategori. <span class="d-none d-md-inline">
                                Kategori yang telah terupdate akan otomatis diperbarui datanya.
                            ...
                            <form class="row" method="POST"
                                ...
                                <div class="col-sm-12">
                                    <div class="btn-showcase">
                                        <button class="btn" type="submit" style="background-color: #0b5b45; border-color: #0b5b45;">Update</button>
