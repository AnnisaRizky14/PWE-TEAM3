...
@section('title', 'Kategori Makanan & Minuman — Temu Rasa')
@section('content')
    ...
    <div class="container-fluid">
        <div class="page-title">
            <div class="card card-absolute mt-5 mt-md-4">
                ...
                <div class="card-body">
                    <p>
                        Inilah kategori makanan dan minuman yang sudah Anda buat.  <span
                            class="d-none d-md-inline">
                            Jangan ragu untuk mengedit ✏️ atau menghapus 🗑️. Klik di sini untuk menambah kategori baru.
                            <a href="{{ url('/admin/categories/create') }}" style="color: #0b5b45;">disini ⇾</a>
                        </span>
                    </p>
                </div>
            </div>
