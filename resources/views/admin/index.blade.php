...
@section('title', 'Admin Dashboard — Temu Rasa')
@section('content')
    ...
    <div class="container-fluid">
                    ...
                    <div class="splide__track">
                        <ul class="splide__list">
                            <li class="splide__slide">
                                <img src="{{ url('images/splide/admin/dashboard1.png') }}"
                                    class="d-block w-100" style="border-radius:8px;">
                            </li>
                            <li class="splide__slide">
                                <img src="{{ url('images/splide/admin/dashboard2.png') }}"
                                    class="d-block w-100" style="border-radius:8px;">
                            </li>
                        </ul>
                    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5 style="color: #0b5b45;">📅 • Jadwal Reservasi</span>
                    </div>
                    <div class="card-body">
